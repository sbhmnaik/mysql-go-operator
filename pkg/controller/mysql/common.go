...
func (r *ReconcileMySQL) ensureDeployment(request reconcile.Request,
...
func (r *ReconcileMySQL) ensureService(request reconcile.Request,
	instance *mysqlv1alpha1.MySQL,
	s *corev1.Service,
) (*reconcile.Result, error) {
...
func (r *ReconcileMySQL) ensureSecret(request reconcile.Request,
	instance *mysqlv1alpha1.MySQL,
	s *corev1.Secret,
) (*reconcile.Result, error) {
	found := &corev1.Secret{}
...
func (r *ReconcileMySQL) ensurePV(request reconcile.Request,
	instance *mysqlv1alpha1.MySQL,
) (*reconcile.Result, error) {
	pvName := resource.GetMysqlVolumeName(instance)
	...
	if err != nil && errors.IsNotFound(err) {
		...
		pv := resource.NewMySqlPV(instance, r.scheme)
...
func (r *ReconcileMySQL) ensurePVC(request reconcile.Request,
	instance *mysqlv1alpha1.MySQL,
) (*reconcile.Result, error) {
	pvcName := resource.GetMysqlVolumeClaimName(instance)
	...
	if err != nil && errors.IsNotFound(err) {
		...
		pvc := resource.NewMySqlPVC(instance, r.scheme)
